<template>
  <header class="h-14 absolute w-full inset-0 px-4 py-3 z-[1000] text-center bg-white dark:bg-gray-900 shadow-[0_0.3125rem_0.625rem_-0.3rem] shadow-gray-200 dark:shadow-gray-600">
    ...
    <div class="flex items-center absolute top-1/2 right-4 -translate-y-1/2">
      ...
      <label for="dark-toggle" class="bg-amber-200 inline-block cursor-pointer w-6 h-6 rounded-full ml-2 transition-all duration-300 ease-[cubic-bezier(0.49,0.59,0.82,0.92)] peer-checked:bg-transparent peer-checked:shadow-[inset_-0.4rem_-0.25rem_1px_1px_#111827]" @click="toggleMode"></label>
